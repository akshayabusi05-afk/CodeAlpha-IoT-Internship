...
This repository contains my internship tasks for CodeAlpha IoT domain.

## Task 1
### Introduction to IoT
- Learned the basics of Internet of Things.
- Studied IoT architecture, applications, and components.
- Submitted the report in PDF format.[Task-1.pdf](https://github.com/user-attachments/files/29597263/Task-1.pdf)
